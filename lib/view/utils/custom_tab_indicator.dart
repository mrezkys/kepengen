...
class RoundedRectangleTabIndicator extends Decoration {
  ...
  RoundedRectangleTabIndicator({@required Color color, @required double weight, @required double width}) : _painter = _RRectanglePainterColor(color, weight, width);
...
class _RRectanglePainterColor extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration cfg) {
    ...
    final Offset customOffset = offset + Offset(cfg.size.width / 2 - (width * 0.5), cfg.size.height - weight);
